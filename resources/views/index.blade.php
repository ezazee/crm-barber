                          ...
                          <table class="table table-bordernone">
                            <tbody>
                              <tr>
                                ...
                                <td><a href="index-2.html" target="_blank">Edit</a></td>
                                <td><a href="index-2.html" target="_blank">Delete</a></td>
                              </tr>
                              <tr>
                                <td>
                                  <div class="media">
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-6 footer-copyright">
                <p class="mb-0">Copyright 2023 © Multi Kara Digital All rights reserved.</p>
              </div>
              <div class="col-md-6">
