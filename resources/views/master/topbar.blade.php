               ...
               <li class="dropdown notification-list">
                            <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false"
                                ...
                                <span class="account-user-avatar"> 
                                    <img src="{{ URL::asset('assets/images/avtar/11.jpg') }}" alt="user-image" class="img-30 rounded-circle">
                                </span>
                                <span>
                                    <span class="account-user-name">Reza</span>
                                </span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated topbar-dropdown-menu profile-dropdown">
                                <!-- item-->
                                <a href="#" class="dropdown-item notify-item">
                                    <i class="fa mdi-face-man-profile"></i>
                                    <span>Detail Profile</span>
                                </a>

                                <!-- item-->
                                <a href="#" class="dropdown-item notify-item text-bg-danger">
